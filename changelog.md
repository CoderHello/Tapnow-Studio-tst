...
### V3.7.31 (Batch & Logic Optimization) - 2026-01-10
...
- **[优化] 队列过滤**: 多次迭代优化了批量生成的过滤条件，确保只有“未锁定且未生成”的镜头进入线程。

### V3.7.30 (UI State Synchronization) - 2026-01-10
**构建文件**: `Tapnow Studio-V3.7.30.html`
- **[P0 修复] 预览回填故障**: 移除了 `setTimeout(0)` 异步包装，直接调用 `setNodes`。解决了高频生成时，预览图无法即时填回节点卡片、界面持续“转圈”的 Bug。
