...
### V3.7.33fp (Isolation Patch - 1006 & Jimeng Video Fixes) - 2026-01-12
**构建文件**: `Tapnow Studio-V3.7.33fp.html`
- **[分支修复] AI 生图/视频分辨率隔离**: 非法分辨率自动规范化，避免图/视频参数互相污染。
- **[分支修复] 默认分辨率校准**: 图片默认 2K，视频默认 720p。
- **[分支修复] Jimeng 视频首尾帧**: multipart 使用 `image_file_1/2` 传首尾帧；分辨率统一为 720p/1080p 小写。
